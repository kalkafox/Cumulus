...
void print(const T& t, const Args&... args) { print(t); print(args...); }

template<typename... Args>
void println(const Args&... args) { print(args...); std::cout << std::endl; }
...
template<typename T>
void print(const std::shared_ptr<T>& ptr) {
    std::cout << ptr.get();
}

template<typename T>
void print(const std::unique_ptr<T>& ptr) {
    std::cout << ptr.get();
}

template<typename T>
void print(const std::weak_ptr<T>& ptr) {
...
template<typename T, typename U>
void print(const std::tuple<T, U>& tuple) {
    std::cout << "(";
    print(std::get<0>(tuple));
    std::cout << ", ";
...
void print(const std::tuple<T, U, V>& tuple) {
    std::cout << "(";
    print(std::get<0>(tuple));
    std::cout << ", ";
    print(std::get<1>(tuple));
...
void print(const std::tuple<T, U, V, W>& tuple) {
    std::cout << "(";
    print(std::get<0>(tuple));
    std::cout << ", ";
    print(std::get<1>(tuple));
